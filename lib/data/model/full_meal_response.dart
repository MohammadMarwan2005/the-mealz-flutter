...
class FullMealResponseModel {
  List<FullMealDataModel>? meals;

  FullMealResponseModel({this.meals});

  FullMealResponseModel.fromJson(Map<String, dynamic> json) {
    if (json['meals'] != null) {
      meals = <FullMealDataModel>[];
      json['meals'].forEach((v) {
        meals!.add(FullMealDataModel.fromJson(v));
      });
    }
  }
  ...
  FullMealDomainModel toDomainModel() => meals![0].toDomainModel();
}

class FullMealDataModel {
  String? idMeal;
  String? strMeal;
  ...
  FullMealDataModel.fromJson(Map<String, dynamic> json) {
    idMeal = json['idMeal'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['strIngredient11'] = data['strIngredient12'] = strIngredient12;
  ...
  List<String> _getValidItems(List<String?> list) {
    List<String> result = [];
  ...
  FullMealDomainModel toDomainModel() {
    final refactoredIngredients = _getValidItems([
      strIngredient1,
      strIngredient2,
      strIngredient3,
      strIngredient4,
    ...
    final refacotedMeasures = _getValidItems([
      strMeasure1,
      strMeasure2,
      strMeasure3,
      strMeasure4,
    ...
    return FullMealDomainModel(
      ...
      areaString: strArea,
      instructionsString: strInstructions,
      strMealThumb: strMealThumb,
      tags: tags,
      strYoutube: strYoutube,
      resource: strSource,
      ingredients: refactoredIngredients,
      measures: refacotedMeasures,
    );
  }
}

class FullMealDomainModel {
  final String? id;
  final String? name;
  ...
  FullMealDomainModel({
    ...
    required this.instructionsString,
